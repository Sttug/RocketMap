...
function pokemonLabel(item) {
    ...
    var currentDate = new Date()
    var currentHour = currentDate.getHours()
    var timeOfDay = (currentHour >= 6 && currentHour < 20) ? 'day' : 'night'
    ...
    if (weatherBoostedCondition) {
        weatherDisplay = `<img src='static/images/weather/${weatherImage(weatherBoostedCondition, timeOfDay)}' style="width: 30px; vertical-align: middle;">`
    }
